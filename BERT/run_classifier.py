...
class MRProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_corpus(os.path.join(data_dir, "train_5k+5k.csv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_corpus(os.path.join(data_dir, "after_attack_test_add_orig.csv")), "dev")
...
def main():
    ...
    parser.add_argument("--data_dir",
                        default='/home/sqsun/workplace/hard-label-attack/BERT/data/after_attack/add_orig/',
                        type=str,
    ...
    parser.add_argument("--output_dir",
                        default='/home/sqsun/workplace/hard-label-attack/bert/adv_training/add_orig/test1/',
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")

    ## Other parameters
    parser.add_argument("--cache_dir",
                        default="/home/sqsun/workplace/hard-label-attack/BERT/pretrained_bert/mr/",
                        # default="/home/sqsun/workplace/hard-label-attack/bert/mr",
                        type=str,
    ...
    if args.local_rank != -1:
        try:
            ...
            raise ImportError(
                "Please install apex from XXXX to use distributed and fp16 training.")
